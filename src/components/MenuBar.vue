            ...
            <div class="setting-wrapper" v-show="ifSettingShow">
                ...
                <div class="setting-theme" v-else-if="showTag === 1">
                    <div class="setting-theme-item"
                        ...
                        <div class="preview"
                        :class="{'no-border' : item.styles.body.background !== '#fff'}"
                        :style="{background: item.styles.body.background}"></div>
  ...
  export default {
    ...
    methods: {
      ...
      setFontSize(setFontSize) {
        this.$emit('setFontSize', setFontSize)
      },
      showSetting(tag) {
        this.showTag = tag;
        if(this.showTag === 3){
